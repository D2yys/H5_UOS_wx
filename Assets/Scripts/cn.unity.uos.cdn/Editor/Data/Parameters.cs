...
namespace AssetStreaming
{
    ...
    public class Parameters
    {
        ...
        public static string k_AssetStreamingSettingsPathPrefix = "Assets/UnityOnlineServiceData/";
        public static string k_UosSettingsPath = "Assets/UnityOnlineServiceData/UosSettings.asset";
        public static string k_AssetStreamingSettingsPath = "Assets/UnityOnlineServiceData/UosCdnSettings.asset";
