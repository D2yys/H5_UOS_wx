...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class DialogLoad : FsmStateAction
	{
		
		[RequiredField]
		[Tooltip("GameObject to create. Usually a Prefab.")]
		public FsmString DialogName;		
		...
		//×ÊÔ´ÊÍ·Åbool
		public FsmBool RelealseBool=true;
		...
		{
			Addressables.LoadAssetAsync<GameObject>(DialogName.ToString()).Completed += (hal) =>
			{
		...
		{
			return "Create: " + ActionHelpers.GetValueLabel(DialogName);
		}
#endif
